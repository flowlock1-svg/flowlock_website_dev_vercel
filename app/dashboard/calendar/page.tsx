    ...
    return (
      <div style={{ padding: "3rem 2rem", maxWidth: "800px", margin: "0 auto", textAlign: "center" }}>
        ...
        <button
          ...
          style={{ background: "#ffffff", color: "#000000", border: "none", borderRadius: "2rem", padding: "0.8rem 2rem", fontWeight: 600, fontSize: "1rem", cursor: "pointer", display: "inline-flex", alignItems: "center", gap: "0.75rem", transition: "transform 0.2s" }}
